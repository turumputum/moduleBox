...
//    }
   ...
   if (pn532_tx (p, 0x14, 0, NULL, n, buf) < 0 || pn532_rx (p, 0, NULL, sizeof (buf), buf, 50) < 0){ // Again
...
int pn532_tx_mutex (pn532_t * p, uint8_t cmd, int len1, uint8_t * data1, int len2, uint8_t * data2){                               // Send data to PN532
   if (p->pending)
...
int pn532_tx (pn532_t * p, uint8_t cmd, int len1, uint8_t * data1, int len2, uint8_t * data2){                               // Send data to PN532
   if (!p)
      return -PN532_ERR_NULL;
...
int pn532_rx_mutex (pn532_t * p, int max1, uint8_t * data1, int max2, uint8_t * data2, int ms){                               // Recv data from PN532
...
int pn532_rx (pn532_t * p, int max1, uint8_t * data1, int max2, uint8_t * data2, int ms){                               // Recv data from PN532
   if (!p)
      return -PN532_ERR_NULL;
   if (!p->pending)
