...
"\n"
    ...
    ";button trigger: [deviceName]/button_[num_of_slot]:val(0-1)\n"
"\n"
    ...
    ";led action: [deviceName]/led_[num_of_slot]:val(0-1)\n"
"\n"
    ...
    ";smartLed action:[deviceName]/smartLed_[num_of_slot]:val(0-1)\n"
    ";smartLed action:[deviceName]/smartLed_[num_of_slot]/setRGB:val(string:R G B)\n"
    ";smartLed action:[deviceName]/smartLed_[num_of_slot]/setMode:val(string:default/flash)\n"
    ";smartLed action:[deviceName]/smartLed_[num_of_slot]/setFadeIncrement:val\n"
"\n"
    ...
    ";pwmRGBled action:[deviceName]/pwmRGBled_[num_of_slot]:val(0-1)\n"
    ";pwmRGBled action:[deviceName]/pwmRGBled_[num_of_slot]/setRGB:val(string:R G B)\n"
    ";pwmRGBled action:[deviceName]/pwmRGBled_[num_of_slot]/setMode:val(string:default/flash)\n"
    ";pwmRGBled action:[deviceName]/pwmRGBled_[num_of_slot]/setFadeIncrement:val\n"
"\n"
    ...
    ";sensor_2ch trigger:[deviceName]/sens_[num_of_slot]:val(0-1)\n"
            "\t\t\t\t\t[deviceName]/sens_[num_of_slot]/ch_1/2:val(0-1)\n"
"\n"
    ";encoder_inc Standard module_mode for all slots \n"
    ";encoder_inc options:inverse, absolute, custom_topic\n"
    ";encoder_inc trigger: [deviceName]/encoder_[num_of_slot]:val(+1/-1)\n"
                "\t\t\t\t\t[deviceName]/encoder_[num_of_slot]:val\n"
"\n"
    ";encoder_PWM Standard module_mode for all slots \n"
    ";encoder_PWM options: num_of_pos:val, incremental||absolute\n"
    ";encoder_PWM trigger: [deviceName]/encoder_[num_of_slot]:val(+1/-1)\n"
                "\t\t\t\t\t[deviceName]/encoder_[num_of_slot]:val(0-num_of_pos)\n"
"\n"
    ...
    ";tachometer trigger: [deviceName]/tachometer_[num_of_slot]:val\n"
"\n"
    ...
    ";analog trigger: [deviceName]/analog_[num_of_slot]:val\n"
"\n"
    ";audio_player module_mode Special for SLOT_0:  \n"
    ";audio_player module_options: volume:val, delay:val\n"
    ";audio_player action: [deviceName]/player_0/play:val(num, +num, -num, random, #-current)\n"
                    "\t\t\t\t\t\t[deviceName]/player_0/shift:val(num, +num, -num, random)\n"
                    "\t\t\t\t\t\t[deviceName]/player_0/stop:val(need, but ignored)\n"
                    "\t\t\t\t\t\t[deviceName]/player_0/setVolume:val(num, +num, -num)\n"
    ";audio_player trigger: [deviceName]/player_0/endOfTrack:val(num_of_track)\n"
"\n"
    ...
    ";stepper action: [deviceName]/stepper_moveTo:val(steps or float) \n"            
        "\t\t\t\t\t\t[deviceName]/stepper_setSpeed:val(stepPerMin)\n"
        "\t\t\t\t\t\t[deviceName]/stepper_stop:val(need, but ignored)\n"
        "\t\t\t\t\t\t[deviceName]/stepper_stop_on_sensor:val(need, but ignored)\n"
        "\t\t\t\t\t\t[deviceName]/stepper_set_currentPos:val\n"
    ";stepper trigger: [deviceName]/stepper_[num_of_slot]:val(current pos)\n"
"\n"
    ...
    ";flywheel action: [deviceName]/led_[num_of_slot]:val(0-1)\n"
    ";flywheel trigger: [deviceName]/flywheel_[num_of_slot]:val\n";