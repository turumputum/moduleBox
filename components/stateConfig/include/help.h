...
"\n"
    ...
    ";encoder_PWM trigger: [device_name]/encoder_[num_of_slot]:val(+1/-1)\n"
                "\t\t\t\t\t[device_name]/encoder_[num_of_slot]:val(0-num_of_pos)\n"
"\n"
...
"\n"
    ...
    ";audio_player action: [device_name]/player_0/play:val(num, +num, -num, random, #-current)\n"
    ...
    ";audio_player trigger: [device_name]/player_0/endOfTrack:val(num_of_track)\n"
"\n"
