...
"                ],\n"
"          \"commands\" : [\n"
"                    { \"command\" : \"system/action/getVersion\",   \"description\" : \"Запросить версию прошивки\",         \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/action/getNETstatus\", \"description\" : \"Запросить статус сети\",             \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/action/getFreeRAM\",   \"description\" : \"Запросить свободную память\",        \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/action/getFreeDisk\",  \"description\" : \"Запросить свободное место на SD\",   \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/action/getTaskList\",  \"description\" : \"Запросить список задач FreeRTOS\",   \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/action/restart\",      \"description\" : \"Перезагрузить устройство\",         \"parametersType\" : \"types\", \"parameters\" : [] }\n"
"                ],\n"
"          \"reports\" : [\n"
"                    { \"topic\" : \"system/event/version\",   \"description\" : \"Версия прошивки\",                 \"valueType\" : \"string\" },\n"
"                    { \"topic\" : \"system/event/netStatus\", \"description\" : \"Статус сети - JSON с интерфейсами\", \"valueType\" : \"string\" },\n"
"                    { \"topic\" : \"system/event/freeRAM\",   \"description\" : \"Свободная оперативная память\",     \"valueType\" : \"int\", \"unit\" : \"bytes\" },\n"
"                    { \"topic\" : \"system/event/freeDisk\",  \"description\" : \"Свободное место на SD\",            \"valueType\" : \"int\", \"unit\" : \"bytes\" },\n"
"                    { \"topic\" : \"system/event/taskList\",  \"description\" : \"Список задач FreeRTOS\",            \"valueType\" : \"string\" }\n"
"                ]\n"
"        },\n"
"        { \"chapter\" : \"LAN\",\n"
"          \"values\" : [\n"
...
"          \"values\" : [\n"
"                    { \"key\" : \"enable\",\n"
"                      \"description\" : \"Включить приём Art-Net на порту 6454\",\n"
"                      \"valueType\" : \"flag\",\n"
"                      \"valueDefault\" : \"false\",\n"
"                      \"enum\" : [ \"false\", \"true\" ]  },\n"
"                    { \"key\" : \"pollReply\",\n"
"                      \"description\" : \"Отвечать на ArtPoll - без этого пульт не увидит устройство\",\n"
"                      \"valueType\" : \"flag\",\n"
"                      \"valueDefault\" : \"true\",\n"
"                      \"enum\" : [ \"false\", \"true\" ]  },\n"
"                    { \"key\" : \"shortName\",\n"
"                      \"description\" : \"Имя ноды в списке пульта, до 17 символов, пусто - deviceName\",\n"
"                      \"valueType\" : \"string\",\n"
"                      \"valueDefault\" : \"\" },\n"
"                    { \"key\" : \"longName\",\n"
"                      \"description\" : \"Описание ноды в свойствах пульта, до 63 символов, пусто - moduleBox deviceName\",\n"
"                      \"valueType\" : \"string\",\n"
"                      \"valueDefault\" : \"\" },\n"
"                    { \"key\" : \"timeout\",\n"
"                      \"description\" : \"Тишина, после которой поток по юниверсу считается пропавшим\",\n"
"                      \"valueType\" : \"int\",\n"
"                      \"unit\" : \"ms\",\n"
"                      \"valueDefault\" : \"3000\" },\n"
"                    { \"key\" : \"oem\",\n"
"                      \"description\" : \"OEM-код Art-Net, 0x00FF - производитель неизвестен\",\n"
"                      \"valueType\" : \"string\",\n"
"                      \"valueDefault\" : \"0x00FF\" },\n"
"                    { \"key\" : \"estaMan\",\n"
"                      \"description\" : \"Код производителя ESTA, 0x7FF0 - диапазон прототипов\",\n"
"                      \"valueType\" : \"string\",\n"
"                      \"valueDefault\" : \"0x7FF0\" },\n"
"                    { \"key\" : \"dmxLog\",\n"
"                      \"description\" : \"Печатать первые каналы принятых кадров в лог раз в секунду\",\n"
"                      \"valueType\" : \"flag\",\n"
"                      \"valueDefault\" : \"false\",\n"
"                      \"enum\" : [ \"false\", \"true\" ]  }\n"
"                ]\n"
