...
"                ],\n"
"          \"commands\" : [\n"
"                    { \"command\" : \"system/getVersion\",   \"description\" : \"Запросить версию прошивки\",         \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/getNETstatus\", \"description\" : \"Запросить статус сети\",             \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/getFreeRAM\",   \"description\" : \"Запросить свободную память\",        \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/getFreeDisk\",  \"description\" : \"Запросить свободное место на SD\",   \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/getTaskList\",  \"description\" : \"Запросить список задач FreeRTOS\",   \"parametersType\" : \"types\", \"parameters\" : [] },\n"
"                    { \"command\" : \"system/restart\",      \"description\" : \"Перезагрузить устройство\",         \"parametersType\" : \"types\", \"parameters\" : [] }\n"
"                ],\n"
"          \"reports\" : [\n"
"                    { \"topic\" : \"system/version\",   \"description\" : \"Версия прошивки\",                 \"valueType\" : \"string\" },\n"
"                    { \"topic\" : \"system/NETstatus\", \"description\" : \"Статус сети - JSON с интерфейсами\", \"valueType\" : \"string\" },\n"
"                    { \"topic\" : \"system/freeRAM\",   \"description\" : \"Свободная оперативная память\",     \"valueType\" : \"int\", \"unit\" : \"bytes\" },\n"
"                    { \"topic\" : \"system/freeDisk\",  \"description\" : \"Свободное место на SD\",            \"valueType\" : \"int\", \"unit\" : \"bytes\" },\n"
"                    { \"topic\" : \"system/TaskList\",  \"description\" : \"Список задач FreeRTOS\",            \"valueType\" : \"string\" }\n"
"                ]\n"
"        },\n"
"        { \"chapter\" : \"LAN\",\n"
"          \"values\" : [\n"
